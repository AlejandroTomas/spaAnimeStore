export function Main(){
    ...
    <main class="mainHome">
            <div id="new-of-day">
                ...
                <div class="info-top">
                    <p>
                        <span>10XP</span>/<span>episode</span>
                    </p>
                </div>
                    ...
                    <div class="slide">
                        ...
                        <div class="item-new-post" data-idpost="Life-strange">
                            ...
                            <div class="new-post-bottom">
                                <h4 id="title-new-post">Yu Gi Oh New Generation</h4>
                                <span id="type-new-post">Cartas Estrategia</span>
                            </div>    
                    ...
                    <div class="slide">
                        ...
                        <div class="item-best-post" data-idpost="Call-of-duty">
                            ...
                            <div class="wrapper-info-best">
                                <h4 id="info-best-title">Tomorrowland</h2>
                                <span id="info-best-extra">Pelicula/Futurista</span>
                            </div>
                        ...
                        <div class="item-best-post">
                            ...
                            <div class="wrapper-info-best">
                                <h4 id="info-best-title">DarkSouls</h2>
                                <span id="info-best-extra">Videojuego/Rol de Acción</span>
                            </div>
                        ...
                        <div class="item-best-post">
                            ...
                            <div class="wrapper-info-best">
                                <h4 id="info-best-title">Sworld World</h2>
                                <span id="info-best-extra">Videojuego/Acción</span>
                            </div>
                        </div>
                        ...
                        <div class="item-best-post">
                            ...
                            <div class="wrapper-info-best">
                                <h4 id="info-best-title">Cloud Sean</h2>
                                <span id="info-best-extra">Videojuego/Rol de Acción</span>
                            </div>
                        </div>
                        ...
                        <div class="item-best-post">
                            ...
                            <div class="wrapper-info-best">
                                <h4 id="info-best-title">Dead Cells</h2>
                                <span id="info-best-extra">Videojuego/Rol de Acción</span>
                            </div>
                        </div>
                        ...
                        <div class="item-best-post">
                            ...
                            <div class="wrapper-info-best">
                                <h4 id="info-best-title">Nier Automata</h2>
                                <span id="info-best-extra">Videojuego/Rol de Acción</span>
                            </div>
                        </div>
            ...
            <div class="animes-post">
                <!-- Animes de Api de tioAnime -->
                <h2>Animes Recomendados</h2>

                <div class="container-item-anime">
